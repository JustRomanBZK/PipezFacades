package com.pipezfacades.client.gt;
...
/**
 * Vendored VERBATIM from LDLib
 * {@code com.lowdragmc.lowdraglib.client.bakedpipeline.FaceQuadBakery}.
 * Repackaged to com.pipezfacades.client.gt; Fabric {@code @Environment(EnvType.CLIENT)} removed;
 * the emissivity {@code QuadTransformers} reference now resolves to Forge's
 * {@code net.minecraftforge.client.model.QuadTransformers} (identical byte behavior in 1.20.1 Forge 47.x)
 * instead of the LDLib copy, so no LDLib import remains. All geometry/UV/winding/normal/shrink/emissivity
 * math is byte-for-byte identical to the LDLib source. This mirrors vanilla
 * {@code net.minecraft.client.renderer.block.model.FaceBakery} for 1.20.1 official (Mojang) mappings.
 *
 * @author KilaBash
 * @date 2023/2/20
