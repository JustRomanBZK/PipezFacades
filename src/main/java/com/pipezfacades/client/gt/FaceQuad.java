 ...
 * {@code com.lowdragmc.lowdraglib.client.bakedpipeline.FaceQuad}.
 * Repackaged to com.pipezfacades.client.gt; Fabric {@code @Environment(EnvType.CLIENT)} removed;
 * lombok {@code @Setter}/{@code @Accessors(chain = true, fluent = true)} replaced with hand-written
 * fluent setters that behave identically. No geometry/UV/winding/normal/shrink/emissivity math changed.
 *
 * @author KilaBash
 * @date 2023/2/20
...
public class FaceQuad {
    ...
    public static class Builder {
        ...
        // --- hand-written fluent setters (replacing lombok @Setter + @Accessors(chain = true, fluent = true)) ---
